...
print('Lista:',vector)
for n in vector: #Para n en vector, n tomara el valor de cada cifra en la lista y se crearan 2 variables llamadas i y n
    i=1
    cont=0
    while(n>=i):#Mientras n sea mayor o igual a i, si el residuo del valor de la lista dividido en i es 0, entonces el contador aumentara 1
        if n%i==0:
            cont+=1
        i+=1#E i siempre aumentara por cada vuelra
